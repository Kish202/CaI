    ...
    extend: {
      colors: {
        ...
        purple: {
          ...
          // For your nav component
          <nav className="shadow-neumorphic bg-neumorphic">
            {/* Nav content */}
          </nav>

          // Or for a more subtle effect
          <nav className="shadow-neumorphic-sm bg-neumorphic">
            {/* Nav content */}
          </nav>

          // For a transparent background with blur
          <nav className="shadow-neumorphic bg-neumorphic-transparent">
            {/* Nav content */}
          </nav> // violet-700 with opacity
