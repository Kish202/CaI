...
export default function Navbar() {
  ...
  className="flex items-center text-sm gap-2 px-4 py-2 rounded-lg  bg-opacity-70 border border-violet-500 text-slate-200/70 hover:shadow-outer hover:shadow-purple-500/70-sm hover:border-violet-400 hover:text-slate-200  hover:bg-transparent  transition-all duration-300"
>
