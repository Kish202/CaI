      ...
      <div className="flex justify-center mx-4">
        <div className="bg-gray-800 bg-opacity-50 rounded-full px-4 py-2 flex gap-6 shadow-inner">
          {['Home', 'About', 'Contact'].map((item) => (
            ...
            >
              <button className="text-gray-200 px-3 py-1 rounded-lg group-hover:dropShadow:glow group-hover:scale-110 transition-all duration-300">
                {item}
              </button>
              <div className="absolute inset-0 rounded-md group-hover:shadow-md group-hover:dropShadow:glow opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
            </div>
          ))}
        </div>
      </div>
