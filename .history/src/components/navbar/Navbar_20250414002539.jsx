...
export default function Navbar() {
  ...
  {isLoggedIn ? (
    <Button 
      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black bg-opacity-70 border border-violet-600 text-violet-200 shadow-[inset_1px_1px_2px_#2e1065,4px_4px_10px_#6b21a8] hover:shadow-[inset_1px_1px_2px_#3b0764,5px_5px_12px_#9333ea] transition-all duration-300"
    >
      <User size={18} />
      <span>User</span>
    </Button>
    ...
    <Button 
      onClick={handleLogin}
      className="flex items-center text-sm gap-2 px-4 py-2 rounded-lg bg-black bg-opacity-70 border border-violet-600 text-slate-200 shadow-[inset_1px_1px_2px_#2e1065,4px_4px_10px_#6b21a8] hover:shadow-[inset_1px_1px_2px_#3b0764,5px_5px_12px_#9333ea] hover:border-violet-400 hover:text-white transition-all duration-300"
    >
