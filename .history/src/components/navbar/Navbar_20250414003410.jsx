...
export default function Navbar() {
  ...
  <div className="bg-violet/50 rounded-full px-6 py-2 flex gap-6 
                  shadow-[inset_4px_4px_8px_rgba(0,0,0,0.4),inset_-4px_-4px_8px_rgba(255,255,255,0.05)] 
                  hover:shadow-[inset_1px_1px_1px_rgba(255,255,255,0.1),inset_-1px_-1px_1px_rgba(0,0,0,0.3)] 
                  transition-all duration-300">
    {['Home', 'About', 'Contact'].map((item) => (
      <button
        key={item}
        className="text-slate-200 text-sm px-4 py-2 rounded-2xl 
                   bg-white/5 
                   border border-violet-800/20 
                   shadow-[inset_2px_2px_3px_rgba(0,0,0,0.4),inset_-2px_-2px_4px_rgba(255,255,255,0.05)] 
                   hover:shadow-[4px_4px_10px_rgba(139,92,246,0.2),-4px_-4px_10px_rgba(255,255,255,0.03)] 
                   hover:scale-[1.03] 
                   transition-all duration-300"
      >
        {item}
  ...
  {isLoggedIn ? (
    <Button 
      className="flex items-center gap-2 px-4 py-2 rounded-xl 
                 ...
                 hover:shadow-[4px_4px_12px_rgba(139,92,246,0.3),-4px_-4px_12px_rgba(255,255,255,0.05)] 
  ...
  className="flex items-center text-sm gap-2 px-4 py-2 rounded-xl 
             ...
             text-slate-200 
             bg-white/5 backdrop-blur-sm 
             shadow-[inset_2px_2px_4px_rgba(0,0,0,0.5),inset_-2px_-2px_3px_rgba(255,255,255,0.05)] 
             hover:shadow-[4px_4px_12px_rgba(139,92,246,0.25),-4px_-4px_12px_rgba(255,255,255,0.04)] 
             hover:border-violet-400 
             transition-all duration-300"
>
  <LogIn size={20} className="transition-all duration-300 group-hover:rotate-12" />
  <span>Sign In</span>
</Button>
