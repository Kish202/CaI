...
export default function Navbar() {
  ...
  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black bg-opacity-70 !border-violet-500 !text-slate-200/70 shadow-[#6e30cc]-sm hover:!border-violet-400 hover:!text-violet-900 transition-all duration-300"
>
