...
export default function Navbar() {
  ...
  onClick={handleLogin}
  variant="outline"
  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black bg-opacity-70 !border-violet-500 !text-violet-600 shadow-neumorphic-sm hover:!border-violet-400 hover:!text-violet-200 transition-all duration-300"
>
