  ...
  <div className="bg-violet/60 rounded-full px-4 py-2 flex gap-6 shadow-inner shadow-purple-700/90 hover:shadow-purple-500/70 transition-all duration-300">
    {['Home', 'About', 'Contact'].map((item) => (
      <div key={item} className="inline-flex">
        <button className="text-slate-300/70 px-3 py-1 text-[] rounded-2xl border border-transparent transition-all duration-300 hover:scale-110 hover:text-slate-300/90 hover:border-violet-700/70 transform origin-center">
          {item}
        </button>
      </div>
    ))}
