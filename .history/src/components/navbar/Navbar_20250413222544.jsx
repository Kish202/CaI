        ...
        <div className="bg-gray-800 bg-opacity-50 rounded-full px-4 py-2 flex gap-6 shadow-inner">
          {['Home', 'About', 'Contact'].map((item) => (
            ...
            >
              ...
              <div className="absolute inset-0 rounded-md group-hover:shadow-md group-hover:shadow-purple-500/30 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
            </div>
          ))}
        </div>
      </div>
