  ...
  {isLoggedIn ? (
    <Button 
      className="flex items-center gap-2 px-4 py-2 rounded-xl 
                 bg-[#0f0f1a] text-violet-300 
                 border border-violet-700/60 
                 shadow-[inset_2px_2px_6px_rgba(255,255,255,0.05),inset_-2px_-2px_6px_rgba(0,0,0,0.5)] 
                 hover:shadow-[4px_4px_12px_rgba(109,40,217,0.3),-4px_-4px_12px_rgba(255,255,255,0.05)] 
                 hover:border-violet-400 hover:text-violet-200 transition-all duration-300"
    >
      <User size={18} />
      <span>User</span>
    </Button>
