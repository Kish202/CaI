...
export default function Navbar() {
  ...
  className="flex items-center text-sm gap-2 px-4 py-2 rounded-lg  bg-opacity-70 border border-violet-500 text-slate-200/70 hover:shadow-outer hover:shadow-[#b08de4] hover:border-violet-400 hover:text-violet-900  hover:bg-transparent  transition-all duration-300"
>
