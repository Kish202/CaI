...
export default function Navbar() {
  ...
  {isLoggedIn ? (
    <Button 
      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black bg-opacity-70 border border-violet-500 text-violet-300 shadow-lg shadow-violet-700/70 hover:border-violet-400 hover:text-violet-200 transition-all duration-300"
    >
      <User size={18} />
      <span>User</span>
    </Button>
    ...
    <Button 
      onClick={handleLogin}
      className="flex items-center text-sm gap-2 px-4 py-2 rounded-lg bg-black bg-opacity-70 border border-violet-500 text-slate-200/80 shadow-lg shadow-violet-700/70 hover:shadow-xl hover:shadow-violet-500/80 hover:border-violet-400 hover:text-slate-200 hover:bg-transparent transition-all duration-300"
    >
