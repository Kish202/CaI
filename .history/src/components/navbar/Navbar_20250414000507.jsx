    ...
    {['Home', 'About', 'Contact'].map((item) => (
      ...
      <div className="flex items-center gap-2">
        {isLoggedIn ? (
          <Button 
          variant="outline" 
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black bg-opacity-70 border border-violet-500 text-violet-300 shadow-neumorphic-sm hover:border-violet-400 hover:text-violet-200 transition-all duration-300"
        >
            <User size={18} />
            <span>User</span>
          </Button>
