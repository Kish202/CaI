    ...
    <nav className={`fixed top-0 left-0 w-full py-4 px-6 flex items-center justify-between transition-all duration-300 z-50 ${
      ...
      <div className="flex items-center">
        <div className="group transition-all duration-300 cursor-pointer">
          ...
          <span className="ml-2 text-slate00  text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-neopurple-300 to-neopurple-500 group-hover:from-neopurple-200 group-hover:to-neopurple-400">CaI</span>
        </div>
      </div>
